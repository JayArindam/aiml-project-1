...
Button(dis1,width=40,pady=2,text='Karlson',bg='#54e1fe',fg='#f8efda',border=0,command=karlson).place(x=28,y=180)
Button(dis1,width=40,pady=2,text='Last Train Home',bg='#54e1fe',fg='#f8efda',border=0,command=last_train).place(x=28,y=210)
Button(dis1,width=40,pady=2,text='Tree Team',bg='#54e1fe',fg='#f8efda',border=0,command=smthng7).place(x=28,y=240)
